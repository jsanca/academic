...
/**
 * Raise this exception when there is not any query associated to the mapping.
 *
 * Date: 5/10/14
 * Time: 11:51 PM
 * @author jsanca
...
public class NoMappingException extends RuntimeException {
     ...
     * @since 1.7
     */
    public NoMappingException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
