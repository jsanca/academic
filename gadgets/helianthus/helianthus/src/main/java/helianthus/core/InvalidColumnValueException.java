...
/**
 * Raise this exception for invalid column values.
 *
 * Date: 5/10/14
 * Time: 11:51 PM
 * @author jsanca
...
public class InvalidColumnValueException extends RuntimeException {
     ...
     * @since 1.7
     */
    public InvalidColumnValueException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
